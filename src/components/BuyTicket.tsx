...
export default function BuyTicket({ eventoId, eventoTitulo, precio, disponibles }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '20px' }}>
        ...
        <div>
          ...
          <div style={{ position: 'relative' }}>
            <svg style={{ position:'absolute', left:'14px', top:'50%', transform:'translateY(-50%)', opacity:0.3 }}
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
            ...
            <div style={{ flex:1, background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:'10px', padding:'10px 16px', textAlign:'center', fontSize:'16px', fontWeight:700, color:'white' }}>
      ...
      {/* Error */}
      {error && (
        <div style={{ background:'rgba(239,68,68,0.1)', border:'1px solid rgba(239,68,68,0.25)', color:'#f87171', fontSize:'13px', padding:'12px 14px', borderRadius:'10px', marginBottom:'16px', display:'flex', alignItems:'center', gap:'8px' }}>
      ...
      {/* Resumen */}
      <div style={{ background:'rgba(124,58,237,0.06)', border:'1px solid rgba(124,58,237,0.15)', borderRadius:'14px', padding:'16px', marginBottom:'16px' }}>
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom: precio > 0 && cantidad > 1 ? '8px' : '0' }}>
        ...
        {precio > 0 && cantidad > 1 && (
          <p style={{ color:'rgba(255,255,255,0.2)', fontSize:'11px', textAlign:'right' }}>
            S/ {precio} por entrada
          </p>
        )}
      </div>
      ...
      <p style={{ color:'rgba(255,255,255,0.15)', fontSize:'11px', textAlign:'center', marginTop:'12px', display:'flex', alignItems:'center', justifyContent:'center', gap:'5px' }}>
